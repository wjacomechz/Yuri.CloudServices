...
{
    public static class YCConversions
    {
        ...
        public static string ExceptionToString(System.Exception Value)
        {
            try
            {
                ...
                msg = YCUtilities.QuitarSaltosLinea(msg, " ");
                return msg;
            }
            catch (YCException)
            {
        ...
        {
            string Formato = "##0";
            int NumDecimales = YCUtilities.ContarDecimales(Value);
        ...
        public static System.Exception StringToException(string excepcion)
        {
            ...
            if (excepcion.Contains("ERUSER:"))
            {
                ...
                return new YCException(excepcion);
            }
            else
            {
